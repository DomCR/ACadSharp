...
namespace ACadSharp
{
	public readonly struct Color : IEquatable<Color>
	{
		...
		public ReadOnlySpan<byte> GetTrueColorRgb()
		{
			...
			if (IsByBlock || IsByLayer)
			{
				return null;
			}

			return _indexRgb[_color].AsSpan();
		}
		...
		public override string ToString()
		{
			...
			var partIndexed = _indexRgb[_color].AsSpan();
			return $"Indexed Color: {Index}, RGB:{partIndexed[0]},{partIndexed[1]},{partIndexed[2]}";
		}
