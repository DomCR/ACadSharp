	...
	private void writeHatchBoundaryPathEdge(Hatch.BoundaryPath.Edge edge)
	{
		...
		switch (edge)
		{
			case Hatch.BoundaryPath.Arc arc:
				...
				this._writer.Write(50, arc.StartAngle * MathHelper.RadToDegFactor);
				this._writer.Write(51, arc.EndAngle * MathHelper.RadToDegFactor);
			...
			case Hatch.BoundaryPath.Ellipse ellipse:
				...
				this._writer.Write(50, ellipse.StartAngle * MathHelper.RadToDegFactor);
				this._writer.Write(51, ellipse.EndAngle * MathHelper.RadToDegFactor);
