	...
	private void writeHatchBoundaryPathEdge(Hatch.BoundaryPath.Edge edge)
	{
		...
		switch (edge)
		{
			case Hatch.BoundaryPath.Arc arc:
				...
				this._writer.Write(50, MathHelper.RadToDeg(arc.StartAngle, normalize: false));
				this._writer.Write(51, MathHelper.RadToDeg(arc.EndAngle, normalize: false));
			...
			case Hatch.BoundaryPath.Ellipse ellipse:
				...
				this._writer.Write(50, MathHelper.RadToDeg(ellipse.StartAngle, normalize: false));
				this._writer.Write(51, MathHelper.RadToDeg(ellipse.EndAngle, normalize: false));
