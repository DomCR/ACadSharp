	...
	public class Segment
	{
		...
		public TextStyle Style
		{
			...
			set
			{
				if (this.Owner != null)
				{
					this._style = this.Owner.updateTableEntry(value, s => this._style = s, this.Owner.Document?.TextStyles);
				}
				else
				{
					this._style = value;
		...
		{
			this._style = this.Owner.updateTableEntry(this._style, s => this._style = s, doc.TextStyles);
		}

		internal void UnassignDocument()
		{
			this.Owner?.Document.LineTypes.RemoveReference(this._style?.Name, this.Owner);
