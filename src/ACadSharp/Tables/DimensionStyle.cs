...
public class DimensionStyle : TableEntry
{
	...
	public BlockRecord ArrowBlock
	{
		...
		set
		{
			this._dimArrowBlock = this.updateTableEntry(value, b => this._dimArrowBlock = b, this.Document?.BlockRecords);
		}
	}
	...
	public BlockRecord DimArrow1
	{
		...
		set
		{
			this._dimArrow1 = this.updateTableEntry(value, b => this._dimArrow1 = b, this.Document?.BlockRecords);
		}
	}
	...
	public BlockRecord DimArrow2
	{
		...
		set
		{
			this._dimArrow2 = this.updateTableEntry(value, b => this._dimArrow2 = b, this.Document?.BlockRecords);
		}
	}
	...
	public BlockRecord LeaderArrow
	{
		...
		set
		{
			this._leaderArrow = this.updateTableEntry(value, b => this._leaderArrow = b, this.Document?.BlockRecords);
		}
	}
	...
	internal override void UnassignDocument()
	{
		...
		this.Document.LineTypes.RemoveReference(this.LineTypeExt1?.Name, this);
		this.Document.LineTypes.RemoveReference(this.LineTypeExt2?.Name, this);

		this.Document.BlockRecords.RemoveReference(this.LeaderArrow?.Name, this);
		this.Document.BlockRecords.RemoveReference(this.DimArrow1?.Name, this);
		this.Document.BlockRecords.RemoveReference(this.DimArrow2?.Name, this);
		this.Document.BlockRecords.RemoveReference(this.ArrowBlock?.Name, this);
		...
		this._lineTypeExt1 = (LineType)(this.LineTypeExt1?.Clone());
		this._lineTypeExt2 = (LineType)(this.LineTypeExt2?.Clone());

		this._leaderArrow = (BlockRecord)(this.LeaderArrow?.Clone());
		this._dimArrow1 = (BlockRecord)(this.DimArrow1?.Clone());
		this._dimArrow2 = (BlockRecord)(this.DimArrow2?.Clone());
		this._dimArrowBlock = (BlockRecord)(this.ArrowBlock?.Clone());
	}
