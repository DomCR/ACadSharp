...
namespace ACadSharp.Objects
{
	...
	public partial class MultiLeaderAnnotContext : NonGraphicalObject
	{
		...
		/// </summary>
		[DxfCodeValue(141)]
		public double BackgroundScaleFactor { get; set; } = 0.0d;
		...
		/// </summary>
		[DxfCodeValue(45)]
		public double LineSpacingFactor { get; set; } = 1.0d;
		...
		//Sublcass doesn't exist in the dxf specification
		/// <summary>
		...
		public XYZ TextNormal { get; set; } = XYZ.AxisZ;
