...
public class ScaleCollection : ObjectDictionaryCollection<Scale>
{
	...
	{
		this._dictionary.TryAdd(new Scale { Name = Scale.DefaultName, PaperUnits = 1.0, DrawingUnits = 1.0, IsUnitScale = true });
	...
	protected override Scale getDefaultEntry()
	{
		return this.GetEntry(Scale.DefaultName);
	}
}